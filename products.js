...
const ICONS = {
  like: `<svg class="like-symbol" viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>`,
...
async function loadProduct() {
  ...
  <div class="image-wrapper">
    <div class="image-container" id="imageContainer">
      <button type="button" class="like-btn" id="likeBtn" aria-label="Like Product">${ICONS.like}</button>
  ...
  <div class="details-section">
    ...
    <div class="horizontal-action-bar">
      <span class="like-count-label" id="likeLabel">${ICONS.like}${likeCount} Likes</span>
...
async function toggleLike() {
  ...
  try {
    ...
    likeLabel.innerHTML = `${ICONS.like}${newCount} Likes`;
